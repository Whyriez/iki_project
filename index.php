...
<section class="site-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <img src="Assets/images/f_img_1.png" alt="Image placeholder" class="img-md-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row ">
            <div class="col-md-7">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="Assets/images/img_1.jpg" alt="Generic placeholder image" class="img-fluid">
            ...
            <div class="col-md-5 room-thumbnail-absolute">
                <a href="#" class="media d-block room bg first-room" style="background-image: url(Assets/images/img_2.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                        <span>
                            Hotel Room
                ...
                <a href="#" class="media d-block room bg second-room" style="background-image: url(Assets/images/img_4.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                        <span>
                            Hotel Room
